...
/***/ (function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)('.autocomplete').on('keyup', updateSuggestion);

	function updateSuggestion() {
	  console.log(autoComplete);
	}

	(0, _jquery2.default)(document).ready(autoFunc);

	function autoFunc() {
	  var availableTags = ["ActionScript", "AppleScript", "Asp", "BASIC", "C", "C++", "Clojure", "COBOL", "ColdFusion", "Erlang", "Fortran", "Groovy", "Haskell", "Java", "JavaScript", "Lisp", "Perl", "PHP", "Python", "Ruby", "Scala", "Scheme"];
	  (0, _jquery2.default)(".autocomplete").autocomplete({
	...
	var Trie = function () {
	  ...
	  _createClass(Trie, [{
	    ...
	    value: function suggest(query) {
	      ...
	      this.suggestionObjects.sort(function (a, b) {
	        return b.count - a.count;
	      });
	      Object.keys(this.suggestionObjects).forEach(function (suggestion) {
	        _this.suggestions.push(_this.suggestionObjects[suggestion].word);
	      });
	    }
	  }, {
	    key: 'findSuggestion',
	    value: function findSuggestion(position, query) {
	      ...
	      Object.keys(position['children']).forEach(function (node) {
	        if (Object.keys(position['children'][node]['children']).length === 0) {
	          _this2.suggestionObjects.push({ word: query + node, count: position['children'][node]['chosenCount'], recency: position['children'][node]['lastChosen'] });
	        } else {
	          return _this2.findSuggestion.call(_this2, position['children'][node], query + node);
	        }
	      });
	    }
	  }, {
